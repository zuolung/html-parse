...
/* harmony default export */ __webpack_exports__["default"] = ({
  htmlObjParser: htmlObjParser,
  htmlStrParser: _parser__WEBPACK_IMPORTED_MODULE_0__["default"]
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return htmlStrParser; });
      ...
      if (status === sign_enum.SIGN_START) {
        ...
        use_line.map(function (_, index) {
          ...
          if (index === use_line.length - 1) {
            ...
            node.children.push(_objectSpread({
              nodeName: mark,
              children: []
            }, attrbuteObj));

            if (mark.includes("script")) {
              scripts.push(_objectSpread({}, attrbuteObj));
            }
